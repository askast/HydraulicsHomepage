...
<head>
  ...
  <title>Hydraulics Homepage&mdash;Lobanoff</title>
    ...
    <div id="menu">
      <div class="pure-menu pure-menu-open">
        ...
        <ul>
          ...
          <li class="menu-item-divided pure-menu-selected"><a href="lobanoff.php">Lobanoff</a></li>
          <li><a href="unitcon.php">Unit Convertion</a></li>
